...
class SummaryChart extends StatelessWidget {
  const SummaryChart({Key key, this.maxValue, this.data1, this.data2})
      : super(key: key);
  final int maxValue;
  ...
  Widget build(BuildContext context) {
    return LineChart(LineChartData(
        ...
        lineBarsData: [
          buildLineChartBarData(data1, [Colors.tealAccent.withOpacity(0.5)]),
          buildLineChartBarData(data2, [Colors.redAccent.withOpacity(0.5)])
        ]));
  }
